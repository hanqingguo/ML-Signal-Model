...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._tx_gain_ch1_win = RangeWidget(self._tx_gain_ch1_range, self.set_tx_gain_ch1, 'TX Gain CH1', "counter_slider", float)
        self.top_layout.addWidget(self._tx_gain_ch1_win)
        self._tx_freq_ch1_range = Range(10e6, 6e9, 100e3, 2.4e9, 200)
        self._tx_freq_ch1_win = RangeWidget(self._tx_freq_ch1_range, self.set_tx_freq_ch1, 'TX Freq CH1', "counter_slider", float)
        self.top_layout.addWidget(self._tx_freq_ch1_win)
        self._rx_gain_ch1_range = Range(0, 50, 1, 50, 200)
        self._rx_gain_ch1_win = RangeWidget(self._rx_gain_ch1_range, self.set_rx_gain_ch1, 'RX Gain CH1', "counter_slider", float)
        self.top_layout.addWidget(self._rx_gain_ch1_win)
        self._rx_freq_ch1_range = Range(10e6, 6e9, 100e3, 2.4e9, 200)
        self._rx_freq_ch1_win = RangeWidget(self._rx_freq_ch1_range, self.set_rx_freq_ch1, 'RX Freq CH1', "counter_slider", float)
        ...
        self._tx_gain_ch2_win = RangeWidget(self._tx_gain_ch2_range, self.set_tx_gain_ch2, 'TX Gain CH2', "counter_slider", float)
        self.top_layout.addWidget(self._tx_gain_ch2_win)
        self._tx_freq_ch2_range = Range(10e6, 6e9, 100e3, 2.4e9, 200)
        self._tx_freq_ch2_win = RangeWidget(self._tx_freq_ch2_range, self.set_tx_freq_ch2, 'TX Freq CH2', "counter_slider", float)
        self.top_layout.addWidget(self._tx_freq_ch2_win)
        self._rx_gain_ch2_range = Range(0, 30, 1, 0, 200)
        self._rx_gain_ch2_win = RangeWidget(self._rx_gain_ch2_range, self.set_rx_gain_ch2, 'RX Gain CH2', "counter_slider", float)
        self.top_layout.addWidget(self._rx_gain_ch2_win)
        self._rx_freq_ch2_range = Range(10e6, 6e9, 100e3, 2.4e9, 200)
        self._rx_freq_ch2_win = RangeWidget(self._rx_freq_ch2_range, self.set_rx_freq_ch2, 'RX Freq CH2', "counter_slider", float)
    ...
    def get_tx_gain_ch2(self):
        return self.tx_gain_ch2

    def set_tx_gain_ch2(self, tx_gain_ch2):
        self.tx_gain_ch2 = tx_gain_ch2
        self.uhd_usrp_sink_0.set_gain(self.tx_gain_ch2, 1)


    def get_tx_gain_ch1(self):
        return self.tx_gain_ch1

    def set_tx_gain_ch1(self, tx_gain_ch1):
        self.tx_gain_ch1 = tx_gain_ch1
        self.uhd_usrp_sink_0.set_gain(self.tx_gain_ch1, 0)


    def get_tx_freq_ch2(self):
        return self.tx_freq_ch2

    def set_tx_freq_ch2(self, tx_freq_ch2):
        self.tx_freq_ch2 = tx_freq_ch2
        self.uhd_usrp_sink_0.set_center_freq(self.tx_freq_ch2, 1)

    def get_tx_freq_ch1(self):
        return self.tx_freq_ch1

    def set_tx_freq_ch1(self, tx_freq_ch1):
        self.tx_freq_ch1 = tx_freq_ch1
        self.uhd_usrp_sink_0.set_center_freq(self.tx_freq_ch1, 0)
    ...
    def get_rx_gain_ch2(self):
        return self.rx_gain_ch2

    def set_rx_gain_ch2(self, rx_gain_ch2):
        self.rx_gain_ch2 = rx_gain_ch2
        self.uhd_usrp_source_0.set_gain(self.rx_gain_ch2, 1)


    def get_rx_gain_ch1(self):
        return self.rx_gain_ch1

    def set_rx_gain_ch1(self, rx_gain_ch1):
        self.rx_gain_ch1 = rx_gain_ch1
        self.uhd_usrp_source_0.set_gain(self.rx_gain_ch1, 0)


    def get_rx_freq_ch2(self):
        return self.rx_freq_ch2

    def set_rx_freq_ch2(self, rx_freq_ch2):
        self.rx_freq_ch2 = rx_freq_ch2
        self.uhd_usrp_source_0.set_center_freq(self.rx_freq_ch2, 1)

    def get_rx_freq_ch1(self):
        return self.rx_freq_ch1

    def set_rx_freq_ch1(self, rx_freq_ch1):
        self.rx_freq_ch1 = rx_freq_ch1
        self.uhd_usrp_source_0.set_center_freq(self.rx_freq_ch1, 0)
